class HomeController < ApplicationController
  def index
    @menus = [
      ...
      #
      { :label => "pxv 高評価10", :path => artists_path(page_title: "高評価10", 
          sort_by: "point", 
          group_by: "評価+年齢制限", 
          exclude_ai: "true",
          status: "「長期更新なし」を除外",
          point: 1, prediction: 3, rating: 10, last_access_datetime: 5, display_number: 3, thumbnail: true) },
      { :label => "pxv 高評価9", :path => artists_path(page_title: "高評価9", sort_by: "point", group_by: "評価+年齢制限", exclude_ai: "true",
          status: "「長期更新なし」を除外",
          point: 1, prediction: 4, rating: 9, last_access_datetime: 10, display_number: 3, thumbnail: true) },
      { :label => "pxv 高評価8", :path => artists_path(page_title: "高評価8", sort_by: "point", group_by: "評価+年齢制限", exclude_ai: "true",
          status: "「長期更新なし」を除外",
      ...
      #{ :label => "twt(file)", :path => artists_twt_index_path(filename: "get illust url_1223", hide_day: 1, hide_target:"") },
      { :label => "全ファイル",
      ...
      { :label => "全ファイル unknown pxv only",
          :path => artists_twt_index_path(
            filename: "all",
            hide_day: 90,
            hide_target:"OTHER_THAN_UNKNOWN_PXV_LIST"
          )
      },
      { :label => "最新ファイル",
          :path => artists_twt_index_path(
            filename: "latest",
            hide_day: 90,
            hide_target:"OTHER_THAN_PXV_LIST",
          )
      },
