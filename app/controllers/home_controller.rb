    ...
    @menus = [
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/登録日順",
        :path => twitters_path(
          ...
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec:  "評価{r1}～::予測{p10}～|評価{r1}",
          rating: 85,
          hide_within_days: 7,
          #pfilenum: -1500,
          select_max: 22,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}保存ファイル少ない",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::SORT_ACCESS,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec:  "登録{cyymm}|評価{r1}～::予測{p10}～|評価{r1}",#"{aw}週|評価{r1}～::予測{p10}～|評価{r1}# {cyymm}",
          rating: 87,
          #hide_within_days: -21,
          pfilenum: -1500,
          select_max: 11,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/予測順(newcomer)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::R_PRED_DESC,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{qq450}評価{r1}::予測{p10}～|{m}ヶ月({w}週)～",
          created_at: 60,
          rating: 84,
          hide_within_days: 3,
          pred: 22,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/登録日順(新参)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::SORT_REGISTERED_DESC,#SORT_CREATE,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{r1}({cw})::予測{p10}～|{m}ヶ月({w}週)～",
          created_at: 60,
          rating: 84,
          #hide_within_days: 7,
          pred: 22,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/アクセス日順(2週間空き+予測)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/アクセス日順(2週間空き)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/アクセス日順(3週間空き+予測)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/アクセス日順(1.5ヶ月空き)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          ...
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,#GRP_SORT_RATE,#,
          #grp_sort_spec: "評価{r1}|{m}ヶ月({w}週)～::{p10}件～# {p25}",
          grp_sort_spec: "{m}ヶ月|評価{r1}|{w}週～::{p10}件～",
          rating: 80,
          hide_within_days: 45,
          #pred: 0,
          select_max: 11,
...
=end
      ...
      { :label => " twt(i)先月",
          :path => artists_twt_index_path(
            ...
            #grp_sort_spec: "[{dm}]{r}|{az}#{Twitter::TWT_H_SEPARATOR}{p25}",
            grp_sort_spec: "[{dm}]{az}|{r}#{Twitter::TWT_H_SEPARATOR}{p25}",
            target: ArtistsController::FileTarget::TWT_I
          )
      },
      { :label => " twt(i) all",
      ...
      { :label => "twt(動画post)", :path => artists_twt_index_path(dir: ArtistsController::DIR_TYPE::DT_MOV_URL) },
      { :label => "twt(dir-sp📲 動画fsチェック)", :path => artists_twt_index_path(dir: ArtistsController::DIR_TYPE::SP_VID) },
      { :label => "-", :path => "" },
      ...
      { :label => "Artist::stats 📲 動画", :path => artists_stats_index_path(target: "video") },
      # ----------------------------
      { :label => "url file", :path => "" },
      { :label => "最新ファイル 全",
          :path => artists_twt_index_path(
            ...
            grp_sort_spec: "{az}#{Twitter::TWT_H_SEPARATOR}{p15}",
          )
      },
      { :label => "今月ファイル ",
          :path => artists_twt_index_path(
