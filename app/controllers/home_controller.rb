class HomeController < ApplicationController
  ...
  def index
    ...
    @menus = [
      ...
      { :label => "pxv" + ArtistsController::MethodEnum::TWT_DB_UNREGISTERED_PXV_USER_ID,
        :path => artists_path(
          #page_title: "PXVテーブル未登録pxv user on TWT DB",
          file: ArtistsController::MethodEnum::TWT_DB_UNREGISTERED_PXV_USER_ID,
        )
      },
      { :label => "pxv AI 優先",
        :path => artists_path(
            ...
            group_spec: "{status}{r}||{am}ヶ月({aw}週)|{p10}",
      ...
      #----------------------------------------
      { :label => "#twt", :path => "" },
      { :label => "#{ApplicationHelper::DM_AI_ICON}優先",
        :path => twitters_path(
          ...
          grp_sort_spec: "{az}::{rr}",
          sort_by: TwittersController::SORT_BY::SORT_PRIORITY_DES,
          ex_sp: true,
          #step: -3,
          #num_of_times: 4,
          #ex_pxv: false,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}優先(アクセス日順)",
        :path => twitters_path(
          ...
          #force_disp_day: 10,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          #grp_sort_spec: "{am}m|{p20}↑|{r}::{az}",
          grp_sort_spec: "{am}m|{rr}::{az}",
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}優先(評価・予測順)",
        :path => twitters_path(
          mode: TwittersController::ModeEnum::MODE_HIGH_PRIORITY,
          target: Twitter::DRAWING_METHOD::DM_AI,
          #rating: 85,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}優先tmp",
        :path => twitters_path(
          ...
          sort_by: TwittersController::SORT_BY::ACCESS_W_PRED_A,
          ex_sp: true,
          #step: -3,
          #num_of_times: 4,
          #ex_pxv: false,
      ...
      { :label => "-", :path => "" },#------------------
      { :label => "#{ApplicationHelper::DM_AI_ICON}ファイル数昇順△(少ない順)",
        :path => twitters_path(
          #page_title: "all",
          ...
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec:  "評価{rr1}～::{az}|予測{p10}～",
          rating: 85,
          cond_or: true,
          hide_within_days: 22,
          pred: 33,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}ファイル数△昇順",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          status: Twitter::TWT_STATUS::STATUS_PATROL,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/ファイル数昇順△(1ヶ月空き)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          status: Twitter::TWT_STATUS::STATUS_PATROL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::R_FILENUM_ASC,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          #grp_sort_spec: "{p50}件～|評価{rr1}|{m}ヶ月({w}週)～::{p10}件～",
          grp_sort_spec: "評価{rr}|{m}ヶ月({w}週)～::{p10}件～",
          rating: 80,
          hide_within_days: 30,
          select_max: 11,
          #num_of_disp: 3,
      ...
      { :label => "-", :path => "" },#------------------
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/登録日順",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::R_SORT_REGISTERED_DESC,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec:  "{am}|{rr}::{az}|{p15}",
          rating: 85,
          hide_within_days: 14,
          #pfilenum: -1500,
          select_max: 22,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/予測数▽順(新)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::R_PRED_DESC,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          #grp_sort_spec: "{qq450}評価{r}::予測{p10}～|{m}ヶ月({w}週)～",
          grp_sort_spec: "評価{r}::予測{p10}～|{m}ヶ月({w}週)～",
          created_at: 60,
          rating: 84,
          cond_or: true,
          hide_within_days: 14,
      ...
      { :label => "-", :path => "" },#------------------
      { :label => "#{ApplicationHelper::DM_AI_ICON}更新頻度高すぎ",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "-", :path => "" },#------------------
      { :label => "#{ApplicationHelper::DM_AI_ICON}予測順",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/予測数順(1週間空き)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "-", :path => "" },#------------------
      { :label => "#{ApplicationHelper::DM_AI_ICON}アクセス週順",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::ACCESS_W,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "評価{r1}::{aw}週|{p40}～件",
          rating: 86,
          hide_within_days: 7,
          select_max: 30,
          num_of_disp: 3,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}アクセス週順(OR)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::ACCESS_W,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{aw4}週|{p30}～件::{aw}週|評価{r1}",
          rating: 88,
          cond_or: true,
          pred: 33,
          hide_within_days: 33,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}アクセス日順",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}アクセス日順(YMD)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}最近アクセス",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
      ...
      { :label => "#{ApplicationHelper::DM_AI_ICON}評価/アクセス日順(1ヶ月空き)",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::R_ACCESS_W_PRED_A,#R_ACCESS,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,#GRP_SORT_RATE,#,
          grp_sort_spec: "評価{r1}|{m}ヶ月({w}週)～::{p10}件～# {p25}",
          rating: 80,
          hide_within_days: 30,
          #pred: 0,
      ...
      { :label => "twt AI アクセス日時順（新→旧）",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          #target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::SORT_ACCESS_N2O,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_NONE,
          #rating: 87,
          hide_within_days: -7,
          select_max: 11,
          #num_of_disp: 3,
      ...
      { :label => "twt AI アクセス日順",
        :path => twitters_path(
          ...
          sort_by: TwittersController::SORT_BY::SORT_ACCESS_O2N,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{m}ヶ月({ad15}日)～|評価{r3}～|予測{p45}～(45)|{w}週::予測{p15}～|評価{r1}",
          rating: 86,
          hide_within_days: 7,
          select_max: 50,
          num_of_disp: 3,
      ...
      { :label => "twt AI xxx",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          filename: TwittersController::FileEnum::FILE_TWEET, #"<tweet>",
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::SORT_ACCESS_O2N,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
...
=end
      ...
      { :label => " twt(i)最近★",
          :path => artists_twt_index_path(
            ...
            grp_sort_spec: TwittersController::GRP_SPC_T_DM + "{r}|{az}|{p25}#{Twitter::TWT_H_SEPARATOR}{r}",
      ...
      { :label => " twt(i)今月",
          :path => artists_twt_index_path(
            ...
            grp_sort_spec: TwittersController::GRP_SPC_T_DM + "{az}|{r}#{Twitter::TWT_H_SEPARATOR}{p50}件",
            target: ArtistsController::FileTarget::FT_TWT_I,
          )
      },
      { :label => " twt(i)先月",
          :path => artists_twt_index_path(
            filename: "lastmonth",
            #grp_sort_spec: TwittersController::GRP_SPC_T_DM + "{r5}|{p25}|{az}#{Twitter::TWT_H_SEPARATOR}{r}",
            #grp_sort_spec: TwittersController::GRP_SPC_T_DM + "{am}|{r}|{az}#{Twitter::TWT_H_SEPARATOR}{p25}",
            grp_sort_spec: TwittersController::GRP_SPC_T_DM + "{az}|{p50}件#{Twitter::TWT_H_SEPARATOR}{r}",
            target: ArtistsController::FileTarget::FT_TWT_I,
          )
      },
      { :label => " twt(i)今月+2",
          :path => artists_twt_index_path(
            filename: "thismonth 2",
            #grp_sort_spec: TwittersController::GRP_SPC_T_DM + "{r5}|{p25}|{az}#{Twitter::TWT_H_SEPARATOR}{r}",
            #grp_sort_spec: TwittersController::GRP_SPC_T_DM + "{az}|{p50}件#{Twitter::TWT_H_SEPARATOR}{r}",
            grp_sort_spec: TwittersController::GRP_SPC_T_DM + TwittersController::GRP_SPC_T_RR_S_AZ,
            target: ArtistsController::FileTarget::FT_TWT_I,
          )
      },
      { :label => " twt(i) all",
      ...
      { :label => "twt 状況チェック:#{Twitter::TWT_STATUS::STATUS_NO_UPDATE_IM}",
        :path => twitters_path(
          mode: TwittersController::ModeEnum::MODE_ALL,
          sort_by: TwittersController::SORT_BY::R_ACCESS,
          status: Twitter::TWT_STATUS::STATUS_NO_UPDATE_IM,
          target: Twitter::DRAWING_METHOD::DM_AI,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{unset}{r}",
          select_max: 11,
      ...
      { :label => "twt 未設定 投稿日順",
        :path => twitters_path(
          ...
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{unset}{pw}週～::予測{p5}～",
          #no_pxv: true,
          rating: 0,
          hide_within_days: 1,
          created_at: 45,
      ...
      { :label => "twt 未設定 アクセス日順",
        :path => twitters_path(
          #page_title: "未設定 id",
          mode: TwittersController::ModeEnum::MODE_ALL,#"id",
          sort_by: TwittersController::SORT_BY::SORT_ACCESS_O2N,
          #grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_PRED_DESC,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{unset}{w}週～::{p10}件～",
          #no_pxv: true,
          rating: 0,
          #cond_or: true,
          hide_within_days: 22,
      ...
      { :label => "twt AI sp_chk",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          filename: TwittersController::FileEnum::FILE_SP_CHK,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::SORT_ACCESS_O2N,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{r}",
      ...
      { :label => "twt AI vid_chk",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::MODE_ALL,
          filename: TwittersController::FileEnum::FILE_VID_CHK,
          target: Twitter::DRAWING_METHOD::DM_AI,
          sort_by: TwittersController::SORT_BY::SORT_ACCESS_O2N,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{rr}",
      ...
      { :label => "Artist::stats",   :path => artists_stats_index_path(target: "") },
      { :label => "Artist::stats 📲 sp",   :path => artists_stats_index_path(target: "sp") },
      { :label => "Artist::stats 📲 動画🎞️", :path => artists_stats_index_path(target: "video") },
      # ----------------------------
      { :label => "url file", :path => "" },
      { :label => "最新ファイル 全1(予測数順)",
          :path => artists_twt_index_path(
            filename: "latest",
            #hide_day: 90,
            rating: rating_std,
            ...
            grp_sort_spec: "{p15}↑|{az}#{Twitter::TWT_H_SEPARATOR}{r}",
          )
      },
      { :label => "最新ファイル 全2(アクセス日順)",
          :path => artists_twt_index_path(
            filename: "latest",
            #hide_day: 90,
            rating: rating_std,
            ...
            #pred: 5,
            target:"twt,twt既知,twt未知,known_pxv,unknown_pxv",
            grp_sort_spec: "{az}|{p50}#{Twitter::TWT_H_SEPARATOR}{r}",
          )
      },
      { :label => "最新ファイル 全3(優先度順)",
          :path => artists_twt_index_path(
            filename: "latest",
            #hide_day: 90,
            rating: rating_std,
            ...
            grp_sort_spec: "{interval}{am}{p100}|{r}#{Twitter::TWT_H_SEPARATOR}{az}|{p15}",
          )
      },
      { :label => "-", :path => "" },
      { :label => "今月ファイル ",
          :path => artists_twt_index_path(
            ...
            #pred: 5,
            target:"twt,twt既知,twt未知,known_pxv,unknown_pxv",
            grp_sort_spec: "{interval}{rr}#{Twitter::TWT_H_SEPARATOR}{az}",
          )
      },
      { :label => "今月ファイル 登録日ごと",
          :path => artists_twt_index_path(
      ...
      { :label => "Twitter [AI] 90 (1回)[5]",
        :path => twitters_path(
          ...
          #pred: 5,
          #force_disp_day: 10,
          mode: TwittersController::ModeEnum::MODE_ALL_IN_ONE,
          step: 1,
          num_of_times: 1,
          ex_pxv: false,
          thumbnail: ""
      ...
      { :label => "🅿️ [AI] 90 (-1ずつ5回)[2個]アクセス順のみ",
          :path => artists_path(
            file: ArtistsController::MethodEnum::MODE_ALL_IN_ONE,
      ...
      { :label => "Twitter 紐づけなし",
        :path => twitters_path(
          page_title: "xx", 
          num_of_disp: NUM_OF_DISP,
          mode: TwittersController::ModeEnum::MODE_UNASSOCIATED_TWT_ACNT,
          thumbnail: "t"
        )
      },
      { :label => "-", :path => "" },
      ...
      { :label => "pxv 検索",
        :path => artists_path(
            file: ArtistsController::MethodEnum::METHOD_SEARCH,
            search_word: " 1234 ",
            target_col: Artist::C_ARTIST_TARGET_AUTO,
            match_method: Artist::C_ARTIST_MATCH_AUTO,
            #file: ArtistsController::MethodEnum::MODE_ALL_IN_1,
            #page_title: "",
            #exclude_ai: "",
            #ai: true,
      ...
      { :label => "Twitter[検索]",
        :path => twitters_path(
          page_title: "🔍️", 
          mode: TwittersController::ModeEnum::MODE_SEARCH, 
          select_max: 22,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{dm}::{r}",
          search_word: "test", 
