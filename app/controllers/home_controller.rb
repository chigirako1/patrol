class HomeController < ApplicationController
  def index
    @menus = [
      ...
      # ----------------------------
      { :label => "", :path => "" },
      { :label => "Artist/pxv 高評価10", :path => artists_path(page_title: "高評価10", sort_by: "point", group_by: "filenum", exclude_ai: "true",
          point: 1, prediction: 1, rating: 10, last_access_datetime: 5, display_number: 3, thumbnail: true) },
      { :label => "Artist/pxv 高評価9", :path => artists_path(page_title: "高評価9", sort_by: "point", group_by: "filenum", exclude_ai: "true",
          point: 1, prediction: 2, rating: 9, last_access_datetime: 10, display_number: 3, thumbnail: true) },
      { :label => "Artist/pxv 高評価8", :path => artists_path(page_title: "高評価8", sort_by: "point", group_by: "filenum", exclude_ai: "true",
          point: 1, prediction: 3, rating: 8, last_access_datetime: 15, display_number: 3, thumbnail: true) },
      { :label => "Artist/pxv 高評価7", :path => artists_path(page_title: "高評価7", sort_by: "point", group_by: "filenum", exclude_ai: "true",
          point: 1, prediction: 5, rating: 7, last_access_datetime: 20, display_number: 3, year: 2023, thumbnail: true) },
      { :label => "Artist/pxv 未設定", :path => artists_path(page_title: "未設定", sort_by: "point", group_by: "filenum", exclude_ai: "true",
      ...
      { :label => "Artist/pxv ご無沙汰", :path => artists_path(page_title: "ご無沙汰", sort_by: "last_ul_date", group_by: "rating",
          point: 0, prediction: 0, rating: 8, last_access_datetime: 60, display_number: 5, year: 0, thumbnail: true) },
      # ----------------------------
