...
=end
      ...
      { :label => "-", :path => "" },
      { :label => "今月ファイル+5 twt未登録",
          :path => artists_twt_index_path(
            filename: "thismonth 5",
            #hide_day: 30,
            #rating: rating_std,
            #show_times: 2,
            #pred: 5,
