class HomeController < ApplicationController
  ...
  def index
    ...
    @menus = [
      ...
      { :label => "#{ApplicationHelper::TWT_ICON}#{ApplicationHelper::DM_AI_ICON}予測数順、保存ファイル少ない",
        :path => twitters_path(
          #page_title: "all",
          ...
          sort_by: TwittersController::SORT_BY::SORT_PRED,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec:  "{aw}週|評価{r1}～::予測{p10}～|評価{r1}# {cyymm}",
          rating: 87,
          #hide_within_days: -21,
          pfilenum: -1500,
          select_max: 11,
      ...
      { :label => "-", :path => "" },#------------------
      { :label => "#{ApplicationHelper::TWT_ICON}#{ApplicationHelper::DM_AI_ICON}アクセス週順1",
        :path => twitters_path(
          #page_title: "all",
          mode: TwittersController::ModeEnum::ALL,
          target: Twitter::DRAWING_METHOD::DM_AI,
...
=end
      ...
      { :label => "twt 未設定 予測数順",
        :path => twitters_path(
          ...
          sort_by: TwittersController::SORT_BY::PRED,
          grp_sort_by: TwittersController::GRP_SORT::GRP_SORT_SPEC,
          grp_sort_spec: "{unset}{aw}週～::予測{p}～|全{f20}ファイル", #"{aw}週～|予測{p5}～::{w}週～|全{f20}ファイル",
          #no_pxv: true,
          rating: 0,
          hide_within_days: 1,
          created_at: 45,
