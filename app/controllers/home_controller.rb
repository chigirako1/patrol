    ...
    @menus = [
      ...
      { :label => "pxv 8 日数経過+予測数",
            :path => artists_path(
                ...
                point: 0,
                prediction: 3,
                last_access_datetime: 40, display_number: 5, year: 0, thumbnail: true
            )
      },
      #
      { :label => "-", :path => "" },
      { :label => "pxv ご無沙汰 30日 10",
            :path => artists_path(
                page_title: "ご無沙汰 30 10", 
                sort_by: "last_ul_date", 
                group_by: "評価+年齢制限",
                exclude_ai: true,
                status: "「長期更新なし」を除外",
      ...
      { :label => "pxv ご無沙汰 45日 9",
            :path => artists_path(
                page_title: "ご無沙汰 45 9", 
                sort_by: "last_ul_date", 
                group_by: "評価+年齢制限",
                exclude_ai: true,
                status: "「長期更新なし」を除外",
